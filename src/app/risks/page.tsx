            ...
            <>
              <div>
                ...
                {loadingAssessments ? (
                  ...
                  <select value={selectedId} onChange={(e) => setSelectedId(e.target.value)} className="w-full rounded-lg border dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    {assessments.map((a) => (
                ...
                {loading ? (
                  ...
                  <tr key={risk.id}>
                    ...
                    <td className="text-xs text-gray-500 dark:text-gray-400">
                      {risk.likelihood.slice(0, 3).toUpperCase()} × {risk.impact.slice(0, 3).toUpperCase()}
                    </td>
                    <td>
                    ...
                    <td className="text-center"><RiskScoreCell score={risk.inherentScore} /></td>
                    <td className="text-center"><RiskScoreCell score={risk.residualScore} /></td>
                    <td>
